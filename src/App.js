...
function App() {
  ...
  const fetchTokens = async () => {
    ...
    const provider = new ethers.providers.JsonRpcProvider("https://indulgent-empty-dew.quiknode.pro/584338d9cbe13305d82fc44c2a21dd71aeb77973/");
  ...
  return (
    <>
      ...
      <meta
        name="description"
        content="Token balance app using QuickNode Token and NFT API v2 bundle"
      />
      ...
      <main>
        <div className="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
          {/* <img
            src="/show-me-the-tokens.png"
            alt="Show me the tokens!!!"
            width={680}
            height={367}
            className="mb-3"
          /> */}
                        ...
                        <table className="min-w-full divide-y-4 divide-gray-200 text-sm">
                          <thead>
                            <tr>
                              ...
                              <th className="whitespace-nowrap py-4 text-left font-bold text-gray-900">TO</th>
                              ...
                              <tr key={index}>
                                ...
                                <td className="py-4 whitespace-nowrap">
                                  <div className="flex items-center">
                                    ...
                                    <div className="ml-4">
                                      <div className="text-sm font-medium text-gray-900">{item.fromAddress}</div>
                                    </div>
                                  </div>
                                </td>
                                ...
                                <td className="py-4 whitespace-nowrap">
                                  <div className="flex items-center">
                                    ...
                                    <div className="ml-4">
                                      <div className="text-sm font-medium text-gray-900">{item.toAddress}</div>
                                    </div>
                                  </div>
                                </td>
                                <td className="py-4 whitespace-nowrap">
                                  <div className="text-sm text-gray-900">
                                    {ethers.utils.formatUnits(item.sentAmount, history.token.decimals)}
                                  </div>
                                </td>
                                ...
                                {token.name && (
                                  <>
                                    ...
                                    <td className="whitespace-nowrap py-4 text-gray-900">
                                      {token.totalBalance !== undefined && token.decimals !== undefined
